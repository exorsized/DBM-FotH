...
local timerFusionPunchCooldown	= mod:NewCDTimer(16, 61903)
...
function mod:SPELL_CAST_START(args)
	...
	elseif args:IsSpellID(61903, 63493) then	-- Fusion Punch
		...
		timerFusionPunchCooldown:Start()
