...
local timerNextShockwave		= mod:NewCDTimer(25, 63982)
local timerRespawnLeftArm		= mod:NewTimer(30, "timerLeftArm") --TODO: needs adjusting
local timerRespawnRightArm		= mod:NewTimer(30, "timerRightArm")	-- TODOL needs adjusting
local timerTimeForDisarmed		= mod:NewTimer(12, "achievementDisarmed")	-- 10 HC / 12 nonHC
