...
L:SetTimerLocalization{
	...
	AlgalonDisappears		= "Algalon disappears"
}
...
L:SetMiscLocalization{
	...
	YellPullFast			= "Your actions are illogical. All possible results for this encounter have been calculated. The Pantheon will receive the Observer's message regardless of outcome.",
...
L:SetWarningLocalization{
	hardmodePullTimerOver		= "Sif despawned"
}
...
L:SetMiscLocalization{
	...
	YellPhase3_2	= "Thank you, friends! Your efforts have yielded some fantastic data!",
...
L:SetTimerLocalization{
	hardmodeSpawn = "Saronite Animus spawn (Hard Mode)"
}
...
L:SetWarningLocalization{
	...
	SpecialWarningAnimus			= "Saronite Animus in 5 sec."	
}
